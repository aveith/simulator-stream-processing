...
class experiment_parameter:
    def __init__(self, ):
        self.app = ['a1', 'a2', 'a3', 'a4', 'a5', 'a10', 'a11', 'a12', 'a13', 'a14', 'app3']
        self.reconfig_iterations = 10000
        self.reconfig_strategies = [1, 4]
        self.config_strategies = [1, 4]
        self.reconfig_constants = [.005, .05, .1, 2]
        self.reconfig_alpha = [.001, .1, .9]  # no
        self.reconfig_gamma = [.005, .05, .1, 2]
        self.reconfig_lambda = [.005, .05, .1, 2]
        self.reconfig_epsilon = [.001, .1, .9, 1]  # no
...
class experiment_configuration:
    def __init__(self, id=0, directory='',
                 ...
                 file_path_stat="", file_operator_stat=""):
